...
- Keep README/CHANGELOG and runbooks aligned with current modules; schema guidance is future-phase only.
...
- Runbooks: `docs/runbooks/` (schema locations will be reintroduced when validation resumes).
