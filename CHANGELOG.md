...
### Changed
- Completed WO-AI-001 by removing AI/tooling references from operator-facing documentation while keeping sandbox guidance in place and leaving script behavior unchanged.
