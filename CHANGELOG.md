...
### Changed
- Updated operator-facing documentation for WO-AI-001 by removing AI/tooling-related tracking parameters from Microsoft Learn URLs, while keeping sandbox guidance untouched and leaving script behavior unchanged.
